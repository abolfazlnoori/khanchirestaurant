...
export function SiteHeader({ activePage }: { activePage: NavigationItemId }) {
  return (
    <>
      <header className="khanchi-header-enter sticky top-0 z-50 hidden h-[96px] border-b border-[var(--header-line)] bg-[var(--header-bg)] shadow-[var(--header-shadow)] backdrop-blur-xl min-[901px]:block">
      ...
      <header className="site-mobile-header khanchi-header-enter sticky top-0 z-50 border-b border-[var(--header-line)] bg-[var(--header-bg)] shadow-[0_8px_24px_rgb(0_25_4/0.045)] backdrop-blur-xl min-[901px]:hidden">
