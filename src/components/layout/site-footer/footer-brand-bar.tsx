export function FooterBrandBar() {
  return (
    <div className="grid min-h-[63px] grid-cols-3 items-center px-[max(6vw,48px)] text-xs max-[900px]:min-h-[112px] max-[900px]:grid-cols-1 max-[900px]:gap-2 max-[900px]:px-7 max-[900px]:py-6">
