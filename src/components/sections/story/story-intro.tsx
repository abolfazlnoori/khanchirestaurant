...
export function StoryIntro() {
  return (
    <div className="mx-auto grid w-[min(1248px,calc(100%-64px))] grid-cols-[256px_1fr_256px] items-center gap-[82px] [direction:ltr] max-[900px]:w-[min(calc(100%-40px),720px)] max-[900px]:grid-cols-2 max-[900px]:gap-x-5 max-[900px]:gap-y-9 max-[420px]:w-[calc(100%-28px)]">
      <div className="relative size-64 max-[900px]:col-start-1 max-[900px]:size-auto max-[900px]:w-[min(170px,100%)] max-[900px]:justify-self-center" data-motion="scale">
        <ImageWithSkeleton className="size-64 object-contain max-[900px]:h-auto max-[900px]:w-full" src="/assets/patterns/khanchi-seal.png" alt="نشان هندسی خانچی با الهام از گره‌چینی ایرانی" width={256} height={256} sizes="(max-width: 900px) 170px, 256px" />
      </div>
      <div className="text-center [direction:rtl] max-[900px]:col-span-full max-[900px]:row-start-1 [&>p:first-child]:justify-center" data-motion="reveal" data-motion-delay="60">
