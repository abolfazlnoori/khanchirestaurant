...
export function GalleryHeading() {
  return (
    <div className="mx-auto grid w-[min(1248px,calc(100%-64px))] grid-cols-[1fr_560px] items-center gap-[128px] [direction:ltr] max-[900px]:block max-[900px]:w-[min(calc(100%-40px),720px)] max-[900px]:text-right max-[900px]:[direction:rtl] max-[600px]:w-[calc(100%-28px)]">
      <div data-motion="reveal-side" className="max-[900px]:hidden">
        <div className="[direction:rtl] min-[1200px]:-translate-x-[50px]">
